...
/**
 * Lighthouse SEO score validation tests for the public website.
 *
 * Tests verify that each page has proper SEO meta tags, structured data,
 * and semantic HTML to achieve Lighthouse SEO score ≥ 90 before merging to production.
 *
 * @internal
 */
final class LighthouseSeoTest extends CIUnitTestCase
{
